...
export class deletedUserProps1679664501036 implements MigrationInterface {
    name = 'deletedUserProps1679664501036'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD "next_payment_date" character varying`);
